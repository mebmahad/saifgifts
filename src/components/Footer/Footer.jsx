    ...
    <footer className="bg-gray-800 text-white pt-12 pb-8">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Saif Gifts</h3>
            <p className="text-gray-400 mb-4">
              Discover unique gifts for every occasion. We specialize in handcrafted items that make every moment special.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <span>support@saifgifts.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-6">
              ...
              <form className="flex">
                <input
                  ...
                  className="px-4 py-2 w-full rounded-l-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-900"
                />
                <button
                  type="submit"
        ...
        <div className="border-t border-gray-700 mt-10 pt-6">
          <p className="text-gray-400 text-center text-sm">
            &copy; {new Date().getFullYear()} Saif Gifts. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
